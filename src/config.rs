...
impl AppConfig {
    pub fn from_env() -> Self {
        Self {
            ...
            site_addr: std::env::var("SITE_ADDR").unwrap_or_else(|_| "0.0.0.0:3000".into()),
            reload_port: std::env::var("RELOAD_PORT").unwrap_or_else(|_| "3001".into()).parse::<u32>().unwrap_or(3001),
        }
    }
}
